...
Theorem empty_grammar_representation_inhabited :
  forall R, inhabited (grammar_representation R).
Proof.
  intro R.
  exact (inhabits (empty_grammar_representation R)).
Qed.
...
Theorem weak_quotient_model_inhabited :
  forall S e tau TI, inhabited (weak_quotient_model S e tau TI).
Proof.
  intros S e tau TI.
  exact (inhabits (concrete_weak_quotient_model S e tau TI)).
Qed.
