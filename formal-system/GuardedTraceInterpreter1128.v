...
Theorem guarded_semantics_nontrivial :
  forall c E, holds c E FTop /\ ~ holds c E FBot.
Proof.
  intros c E. simpl. tauto.
Qed.
...
Record GuardedTraceInterpreterSystem : Type := {
  ...
  gti_semantic_nontriviality :
    forall c E, gti_holds c E FTop /\ ~ gti_holds c E FBot;
  gti_tau_p_guard :
    forall p c B E, tau_p (CGuard c B) E p = tau_p c E p;
...
Definition GTI_1128 : GuardedTraceInterpreterSystem := {|
  ...
  gti_holds := holds;
  gti_semantic_nontriviality := guarded_semantics_nontrivial;
