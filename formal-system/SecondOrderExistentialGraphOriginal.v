...
Lemma unit_full_model_bottom_refuted :
  ~ sat_full unit_full_model unit_full_ienv empty_full_renv FBot.
Proof.
  unfold FBot. cbn. tauto.
Qed.
...
Theorem unit_full_model_nontrivial :
  ...
  exists rho : renv unit_full_model,
    ...
    ~ sat_full unit_full_model alpha rho FBot.
Proof.
  exists unit_full_ienv, empty_full_renv.
  split.
  - exact unit_full_model_top.
  - exact unit_full_model_bottom_refuted.
Qed.
...
Record second_order_existential_graph_original_system : Type := {
  ...
  fs_full_model_nontrivial :
    ...
    exists rho : renv fs_full_model,
      ...
      ~ sat_full fs_full_model alpha rho FBot;
