...
Record complete_system : Type := {
  ...
  system_certificate_context : certificate_context;
...
Definition final_system : complete_system :=
  {| system_library := L;
     ...
     system_certificate_context :=
       {| function_code := fun _ => False;
          decode := fun _ _ => False;
          decode_unique := fun e k l H => match H with end;
          zfc_proof := fun _ _ => False |};
