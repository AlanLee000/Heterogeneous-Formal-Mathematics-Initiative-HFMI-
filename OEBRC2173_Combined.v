...
From Coq Require Import List Bool Arith Lia PeanoNat Wf_nat Relations
...
From Coq Require Import List Bool Arith Lia PeanoNat Relations Relation_Definitions.
Import ListNotations.
Set Implicit Arguments.
...
Definition reaches (C C' : config) : Prop := exists r : run C C', True.
...
Theorem O5_three_resumptions_are_legal : exists r : Run3 C0 C3, True.
Proof. exists witness_six_step_run. exact I. Qed.
